...
HD_PWD='P:/IUP/Projekty/Laby/IUP_Laby/Lab6/Lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log enc_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source enc_mem.tcl
