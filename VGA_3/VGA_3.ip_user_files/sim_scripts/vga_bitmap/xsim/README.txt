...
#
# Generated by export_simulation on Thu Apr 06 23:44:33 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './vga_bitmap.sh' script.

./vga_bitmap.sh -reset_run
...
./vga_bitmap.sh -noclean_files

For more information on the script, please type './vga_bitmap.sh -help'.
