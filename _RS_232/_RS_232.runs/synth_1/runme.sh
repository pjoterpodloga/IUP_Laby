...
HD_PWD='P:/IUP/Projekty/Laby/IUP_Laby/_RS_232/_RS_232.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log async_clk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source async_clk.tcl
